...
- Built and evolved architecture to support growth without sacrificing maintainability.
- Mentored engineers and raised the quality bar for design and execution.

I am especially interested in {{CompanyReason}} and would value the chance to contribute to {{TeamOrProductArea}}.
